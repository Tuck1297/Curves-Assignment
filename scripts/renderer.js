class Renderer {
    ...
    drawSlide3(ctx) {
        ...
        // Letter U
        // Circle letter u
        this.drawCircle({x:190, y:340}, 15, color, ctx);
        this.drawCircle({x:190, y:300}, 15, color, ctx);
        this.drawCircle({x:190, y:260}, 15, color, ctx);
        this.drawCircle({x:210, y:230}, 15, color, ctx);
        this.drawCircle({x:250, y:220}, 15, color, ctx);
        this.drawCircle({x:290, y:225}, 15, color, ctx);
        this.drawCircle({x:290, y:190}, 15, color, ctx);
        this.drawCircle({x:290, y:260}, 15, color, ctx);
        this.drawCircle({x:290, y:300}, 15, color, ctx);
        this.drawCircle({x:290, y:340}, 15, color, ctx);
    ...
    drawCircle(center, radius, color, ctx) {
        ...
        let radii = 0;
        let points = this.num_curve_sections;
        if (this.show_points == false && radius == 10) {
            points = 16;
        }
        ...
        for (let i = 0; i <= points; i++) {
            ...
            radii = radii + (360 / points) * Math.PI/180;
    ...
    drawBezierCurve(pt0, pt1, pt2, pt3, color, ctx) {
        ...
        if (this.show_points === true) {
            ...
            for (let i = 0; i <= this.num_curve_sections; i++) {
                ...
                t = t + 1.0 / this.num_curve_sections;
                this.drawCircle({ x: x, y: y }, 10, [0, 100, 0, 255], ctx);
            }
            this.show_points = true;
        }
    }
